...
contract DOTKImplementation {
    ...
    string public constant name = "DOTK"; // solium-disable-line uppercase
    string public constant symbol = "DOTK"; // solium-disable-line uppercase
